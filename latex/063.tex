\chapter{The Stanford Prison Experiment,
...
``I'm---'' she said. ``I'm only twelve, I haven't \emph{done} anything
yet---''
...
``You haven't heard?'' hissed their Head of House as he came close.
...
``Thank you,'' whispered Lesath, ``thank you, my Lord, oh, thank you,''
...
\emph{Would I cry?} wondered Harry. \emph{If I knew nothing, if I was
...
\emph{Didn't you once think about how the person being blackmailed, if
...
He should've remembered that promise to Hermione \emph{before} going to
Azkaban.
...
37 of 40 subjects had continued their participation in that experiment
...
\emph{Isn't there some sort of rule that people who want power shouldn't
have it? Maybe we should make Hermione the ruler instead.}
...
\emph{Slow down,} thought Harry at his components, \emph{we don't have
...
\ldots{}whether `Professor Quirrell' was just one more name on the list,
...
``I can't talk about it,'' Harry said in a bare whisper. ``Can't talk
